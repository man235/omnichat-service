...
async def saleman_send_message_to_anonymous(room, message: NatsChatMessage):
    ...
    message_corechat_ws = livechat_format_message_from_corechat_to_websocket(room, message, constants.LIVECHAT_NEW_MESSAGE_ACK)
    message_corechat_webhook = livechat_format_message_from_corechat_to_webhook(room, message, constants.LIVECHAT_NEW_MESSAGE)
